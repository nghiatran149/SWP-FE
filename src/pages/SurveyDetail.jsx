...
const QUESTION_TYPE_OPTIONS = [
  ...
  { value: 'TEXT', label: 'Câu trả lời tự do' },
  { value: 'SCALE', label: 'Thang đo' },
  { value: 'string', label: 'Câu trả lời tự do' },
];
    ...
    <>
      <div className="bg-white border-b border-gray-200 px-8 py-6">
        <div className="flex justify-between items-center">
          ...
          <Link to="/surveymanagement" className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Nội dung câu hỏi</th>
                ...
                {filteredQuestions.map((question) => (
                  <tr key={question.questionId} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      ...
                      {question.questionType === 'SCALE' && 'Thang đo'}
                      {question.questionType === 'string' && 'Câu trả lời tự do'}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      <div className="flex items-center justify-center gap-2">
                        <button className="p-2 rounded hover:bg-blue-50 text-blue-600" title="Xem chi tiết">
